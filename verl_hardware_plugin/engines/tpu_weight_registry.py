...
"""Lightweight CPU-only Ray actor registry for tracking TPU weight checkpoint references and buckets."""
...
class TPUWeightRegistryState:
    """In-memory state container for holding references to synchronized TPU model weights and 512 MiB buckets."""
